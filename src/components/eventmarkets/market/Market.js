...
class Market extends React.Component {
  ...
  render() {
    if(this.props.marketData) {
      const outcomes = this.props.marketData.data.outcomes.map((outcome) => <Outcome outcomeId={outcome} key={outcome} socket={this.props.socket} oddFormat={this.props.oddFormat} />)
      return (
